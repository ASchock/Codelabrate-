...
namespace TeacherStudentEditor.Migrations
{
    ...
    [Migration("20181209214856_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherStudentEditor.Models.EditorFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("EditorFile");
                });

            modelBuilder.Entity("TeacherStudentEditor.Models.FileQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("EditorFileId");

                    b.ToTable("FileQuestion");
                });

            modelBuilder.Entity("TeacherStudentEditor.Models.FileQuestionComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid?>("FileQuestionId");
                    ...
                    b.HasIndex("FileQuestionId");

                    b.HasIndex("UserId");

                    b.ToTable("FileQuestionComment");
                });
            ...
            modelBuilder.Entity("TeacherStudentEditor.Models.EditorFile", b =>
                {
                    b.HasOne("TeacherStudentEditor.Models.Class")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("TeacherStudentEditor.Models.FileQuestion", b =>
                {
                    ...
                    b.HasOne("TeacherStudentEditor.Models.EditorFile")
                        .WithMany("Questions")
                        .HasForeignKey("EditorFileId");
                });

            modelBuilder.Entity("TeacherStudentEditor.Models.FileQuestionComment", b =>
                {
                    b.HasOne("TeacherStudentEditor.Models.FileQuestion")
                        .WithMany("Comments")
                        .HasForeignKey("FileQuestionId");
